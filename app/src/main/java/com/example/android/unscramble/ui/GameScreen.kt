...
@Composable
fun GameScreen(modifier: Modifier = Modifier, gameViewModel: GameViewModel = GameViewModel()) {
    Column(
        modifier = modifier
...
@Composable
fun GameLayout(modifier: Modifier = Modifier, currentScrambleWord: String, onUserGuessChanged: (String) -> Unit,
            onKeyboardDone: () -> Unit) {
    Column(
